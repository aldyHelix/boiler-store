        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm p-0">
            ...
            <ul class="navbar-nav mr-auto">
                <li>
                    ...
                    <span class="ladmin-greating">Hi, {{ Str::limit($ladminUser->name, 10) }} <small
                            class="text-muted">/ {{ $ladminUser->role->name }}</small></span>
                </li>
            </ul>
            ...
            <ul class="ladmin-navbar-nav d-flex align-items-center justify-content-center ml-auto pr-3">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle pl-0" href="#" role="button"
                        ...
                        <img src="{{ $ladminUser->gravatar_url }}" alt="Avatar" class="img-thumbnail rounded-circle"
                            width="40">
                    </a>

                    <ul style="right:0;"
                        class="dropdown-menu mt-2 rounded shadow-sm dropdown-menu-right ladmin-top-menu"
                            ...
                            <div class="col-lg-6 position-relative align-middle">
                                <h4 class="d-inline-block mr-2">
                                    ...
                                    <a href="{{ request()->get('back') }}"
                                        class="btn btn-outline-primary btn-sm mr-1 px-3">&larr;</a>
                                    @endif
                                    {!! $title ?? 'Title Page' !!}
                                </h4>
                                {{ $buttons ?? null }}
