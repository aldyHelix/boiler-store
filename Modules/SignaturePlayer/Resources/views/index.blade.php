<x-base-layout>
    ...
    <x-slot name="title">
        <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Signature Player</h1>
    </x-slot>
    <x-slot name="button_create">
        ...
        <div data-bs-toggle="tooltip" data-bs-placement="left" data-bs-trigger="hover"
            title="Create a new signature player">
            <a href="{{ route('administrator.master-data.signature-player.create', ['back' => request()->fullUrl()]) }}"
